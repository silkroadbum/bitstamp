function LeftChartMenu() {
  return (
    <div className="w-14 text-gray-500 flex flex-col">
      <ul className="w-full bg-zinc-800 border border-gray-700 flex flex-col items-center pt-2 pb-2">
        ...
        <li className="hover:text-white cursor-pointer mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
            <path
              fill="currentColor"
              d="m9.5 5C8.68 5 8 5.67 8 6.5v2h1v-2c0-.27.23-.5.5-.5H14v16h-2v1h5v-1h-2V6h4.5c.28 0 .5.22.5.5v2h1v-2c0-.83-.67-1.5-1.5-1.5h-10z"></path>
          </svg>
        </li>
        <li className="hover:text-white cursor-pointer mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
      ...
      <ul className="w-full bg-zinc-800 border-l border-r border-gray-700 flex flex-col items-center pt-2 pb-2">
        <li className="hover:text-white cursor-pointer mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
            <g fill="currentColor">
              <path d="M18 15h8v-1h-8z"></path>
        ...
        <li className="hover:text-white cursor-pointer mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
            <g fill="currentColor" fillRule="evenodd">
              <path
                fillRule="nonzero"
                d="M14 10a2 2 0 0 0-2 2v11H6V12c0-4.416 3.584-8 8-8s8 3.584 8 8v11h-6V12a2 2 0 0 0-2-2zm-3 2a3 3 0 0 1 6 0v10h4V12c0-3.864-3.136-7-7-7s-7 3.136-7 7v10h4V12z"></path>
        ...
        <li className="hover:text-white cursor-pointer mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
            <g fill="currentColor" fillRule="evenodd">
              <path
                fillRule="nonzero"
                d="M23.002 23C23 23 23 18.003 23 18.003L15.998 18C16 18 16 22.997 16 22.997l7.002.003zM15 18.003A1 1 0 0 1 15.998 17h7.004c.551 0 .998.438.998 1.003v4.994A1 1 0 0 1 23.002 24h-7.004A.993.993 0 0 1 15 22.997v-4.994z"></path>
              <path d="M19 20h1v2h-1z"></path>
              <path
                fillRule="nonzero"
                d="M22 14.5a2.5 2.5 0 0 0-5 0v3h1v-3a1.5 1.5 0 0 1 3 0v.5h1v-.5z"></path>
              <g fillRule="nonzero">
